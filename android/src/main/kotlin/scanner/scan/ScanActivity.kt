...
class ScanActivity : BaseActivity(), IScanView.Proxy {
    ...
    override fun prepare() {
        ...
        if (this.checkSelfPermission(android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED &&
            ...
            this.requestPermissions(arrayOf(android.Manifest.permission.CAMERA, android.Manifest.permission.WRITE_EXTERNAL_STORAGE), REQUEST_CAMERA_PERMISSION)
        } else if (this.checkSelfPermission( android.Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
